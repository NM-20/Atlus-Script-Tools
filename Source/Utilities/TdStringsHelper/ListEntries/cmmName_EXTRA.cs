...
internal class cmmName_EXTRA {
  ...
  */
  ...
  private cmmName_EXTRA() {
    Name = "";
  }

  public static cmmName_EXTRA ReadIn(BinaryValueReader in_reader) {
    cmmName_EXTRA result = new();
  ...
  public static cmmName_EXTRA ReadIn(string[] in_strings, JObject in_metadata) {
    cmmName_EXTRA result = new();
