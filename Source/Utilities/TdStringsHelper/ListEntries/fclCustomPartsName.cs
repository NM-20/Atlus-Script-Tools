...
internal class fclCustomPartsName {
  ...
  */
  ...
  private fclCustomPartsName() {
    Name = "";
  }

  public static fclCustomPartsName ReadIn(BinaryValueReader in_reader) {
    fclCustomPartsName result = new();
  ...
  public static fclCustomPartsName ReadIn(string[] in_strings, JObject in_metadata) {
    fclCustomPartsName result = new();
