...
internal class fclMmtShopSelMessage {
  ...
  */
  ...
  private fclMmtShopSelMessage() {
    Name = "";
  }

  public static fclMmtShopSelMessage ReadIn(BinaryValueReader in_reader) {
    fclMmtShopSelMessage result = new();
  ...
  public static fclMmtShopSelMessage ReadIn(string[] in_strings, JObject in_metadata) {
    fclMmtShopSelMessage result = new();
