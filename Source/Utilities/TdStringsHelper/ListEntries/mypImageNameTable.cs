...
internal class mypImageNameTable {
  ...
  */
  ...
  private mypImageNameTable() {
    Name = "";
  }

  public static mypImageNameTable ReadIn(BinaryValueReader in_reader) {
    mypImageNameTable result = new();
  ...
  public static mypImageNameTable ReadIn(string[] in_strings, JObject in_metadata) {
    mypImageNameTable result = new();
