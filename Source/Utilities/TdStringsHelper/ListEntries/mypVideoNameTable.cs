...
internal class mypVideoNameTable {
  ...
  */
  ...
  private mypVideoNameTable() {
    Name = "";
  }

  public static mypVideoNameTable ReadIn(BinaryValueReader in_reader) {
    mypVideoNameTable result = new();
  ...
  public static mypVideoNameTable ReadIn(string[] in_strings, JObject in_metadata) {
    mypVideoNameTable result = new();
