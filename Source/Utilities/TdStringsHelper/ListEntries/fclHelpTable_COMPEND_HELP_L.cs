...
internal class fclHelpTable_COMPEND_HELP_L {
  ...
  */
  ...
  private fclHelpTable_COMPEND_HELP_L() {
    Text = "";
  }

  public static fclHelpTable_COMPEND_HELP_L ReadIn(BinaryValueReader in_reader) {
    fclHelpTable_COMPEND_HELP_L result = new();
  ...
  public static fclHelpTable_COMPEND_HELP_L ReadIn(string[] in_strings, JObject in_metadata) {
    fclHelpTable_COMPEND_HELP_L result = new();
