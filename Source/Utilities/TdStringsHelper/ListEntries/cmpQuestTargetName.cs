...
internal class cmpQuestTargetName {
  ...
  */
  ...
  private cmpQuestTargetName() {
    Name = "";
  }

  public static cmpQuestTargetName ReadIn(BinaryValueReader in_reader) {
    cmpQuestTargetName result = new();
  ...
  public static cmpQuestTargetName ReadIn(string[] in_strings, JObject in_metadata) {
    cmpQuestTargetName result = new();
