...
internal class mypOrnamentNameTable {
  ...
  */
  ...
  private mypOrnamentNameTable() {
    Name = "";
  }

  public static mypOrnamentNameTable ReadIn(BinaryValueReader in_reader) {
    mypOrnamentNameTable result = new();
  ...
  public static mypOrnamentNameTable ReadIn(string[] in_strings, JObject in_metadata) {
    mypOrnamentNameTable result = new();
