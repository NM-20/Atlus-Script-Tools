...
internal class fclPublicShopName {
  ...
  */
  ...
  private fclPublicShopName() {
    Name = "";
  }

  public static fclPublicShopName ReadIn(BinaryValueReader in_reader) {
    fclPublicShopName result = new();
  ...
  public static fclPublicShopName ReadIn(string[] in_strings, JObject in_metadata) {
    fclPublicShopName result = new();
