...
internal class FLDLMAPLOCKEDCORPNAME {
  ...
  */
  ...
  private FLDLMAPLOCKEDCORPNAME() {
    Name = "";
  }

  public static FLDLMAPLOCKEDCORPNAME ReadIn(BinaryValueReader in_reader) {
    FLDLMAPLOCKEDCORPNAME result = new();
  ...
  public static FLDLMAPLOCKEDCORPNAME ReadIn(string[] in_strings, JObject in_metadata) {
    FLDLMAPLOCKEDCORPNAME result = new();
