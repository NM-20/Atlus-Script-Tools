...
internal class mypSoundNameTable {
  ...
  */
  ...
  private mypSoundNameTable() {
    Name = "";
  }

  public static mypSoundNameTable ReadIn(BinaryValueReader in_reader) {
    mypSoundNameTable result = new();
  ...
  public static mypSoundNameTable ReadIn(string[] in_strings, JObject in_metadata) {
    mypSoundNameTable result = new();
