...
internal class fclHelpTable_COMPEND_HELP {
  ...
  */
  ...
  private fclHelpTable_COMPEND_HELP() {
    Text = "";
  }

  public static fclHelpTable_COMPEND_HELP ReadIn(BinaryValueReader in_reader) {
    fclHelpTable_COMPEND_HELP result = new();
  ...
  public static fclHelpTable_COMPEND_HELP ReadIn(string[] in_strings, JObject in_metadata) {
    fclHelpTable_COMPEND_HELP result = new();
