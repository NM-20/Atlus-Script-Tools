...
internal class cmmFunctionName {
  ...
  */
  ...
  private cmmFunctionName() {
    Name = "";
  }

  public static cmmFunctionName ReadIn(BinaryValueReader in_reader) {
    cmmFunctionName result = new();
  ...
  public static cmmFunctionName ReadIn(string[] in_strings, JObject in_metadata) {
    cmmFunctionName result = new();
