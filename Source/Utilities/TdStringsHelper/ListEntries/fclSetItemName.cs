...
internal class fclSetItemName {
  ...
  */
  ...
  private fclSetItemName() {
    Name = "";
  }

  public static fclSetItemName ReadIn(BinaryValueReader in_reader) {
    fclSetItemName result = new();
  ...
  public static fclSetItemName ReadIn(string[] in_strings, JObject in_metadata) {
    fclSetItemName result = new();
