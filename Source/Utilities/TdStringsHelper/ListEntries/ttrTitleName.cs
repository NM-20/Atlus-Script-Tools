...
internal class ttrTitleName {
  private const int FIXED_LENGTH = 64;

  public string Name { get; private set; }

  protected ttrTitleName() {
    Name = "";
  }

  public static ttrTitleName ReadIn(BinaryValueReader in_reader) {
    ttrTitleName result = new();
  ...
  public static ttrTitleName ReadIn(string[] in_strings, JObject in_metadata) {
    ttrTitleName result = new();
