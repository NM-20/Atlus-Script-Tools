...
internal class cmpConfigHelpSteam {
  ...
  */
  ...
  private cmpConfigHelpSteam() {
    Description = "";
  }

  public static cmpConfigHelpSteam ReadIn(BinaryValueReader in_reader) {
    cmpConfigHelpSteam result = new();

    result.Description = in_reader.ReadString(
      StringBinaryFormat.FixedLength, FIXED_LENGTH);

    return result;
  }

  public static cmpConfigHelpSteam ReadIn(string[] in_strings, JObject in_metadata) {
    cmpConfigHelpSteam result = new();

    result.Description = in_strings[in_metadata.Property("Description")!.ToObject<uint>()];
  ...
  public void WriteOut(UniqueStreamWriter in_strings_writer, JsonTextWriter in_metadata_writer) {
    ...
    in_metadata_writer.WritePropertyName(
      "Description");
    in_metadata_writer.WriteValue(in_strings_writer.WriteLine(Description));
  ...
  public void WriteOut(BinaryValueWriter in_writer) {
    ...
    */
    in_writer.WriteStringTruncated(Description, FIXED_LENGTH);
  }
}
