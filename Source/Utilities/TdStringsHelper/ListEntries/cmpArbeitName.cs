...
internal class cmpArbeitName {
  ...
  */
  ...
  private cmpArbeitName() {
    Name = "";
  }

  public static cmpArbeitName ReadIn(BinaryValueReader in_reader) {
    cmpArbeitName result = new();
  ...
  public static cmpArbeitName ReadIn(string[] in_strings, JObject in_metadata) {
    cmpArbeitName result = new();
