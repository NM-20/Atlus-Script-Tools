...
internal class cmpCalName {
  ...
  */
  ...
  public static cmpCalName ReadIn(BinaryValueReader in_reader) {
    cmpCalName result = new();
  ...
  public static cmpCalName ReadIn(string[] in_strings, JObject in_metadata) {
    cmpCalName result = new();
