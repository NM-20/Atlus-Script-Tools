...
internal class cmpQuestName {
  ...
  */
  ...
  private cmpQuestName() {
    Name = "";
  }

  public static cmpQuestName ReadIn(BinaryValueReader in_reader) {
    cmpQuestName result = new();
  ...
  public static cmpQuestName ReadIn(string[] in_strings, JObject in_metadata) {
    cmpQuestName result = new();
