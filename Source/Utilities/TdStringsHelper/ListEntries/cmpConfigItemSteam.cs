...
internal class cmpConfigItemSteam {
  ...
  */
  ...
  private cmpConfigItemSteam() {
    Name = "";
  }

  public static cmpConfigItemSteam ReadIn(BinaryValueReader in_reader) {
    cmpConfigItemSteam result = new();
  ...
  public static cmpConfigItemSteam ReadIn(string[] in_strings, JObject in_metadata) {
    cmpConfigItemSteam result = new();
