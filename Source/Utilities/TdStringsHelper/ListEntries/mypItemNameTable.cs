...
internal class mypItemNameTable {
  ...
  */
  ...
  private mypItemNameTable() {
    Name = "";
  }

  public static mypItemNameTable ReadIn(BinaryValueReader in_reader) {
    mypItemNameTable result = new();
  ...
  public static mypItemNameTable ReadIn(string[] in_strings, JObject in_metadata) {
    mypItemNameTable result = new();
