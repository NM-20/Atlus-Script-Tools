...
internal class fclMmtShopNumHeroMessage {
  ...
  */
  ...
  private fclMmtShopNumHeroMessage() {
    Name = "";
  }

  public static fclMmtShopNumHeroMessage ReadIn(BinaryValueReader in_reader) {
    fclMmtShopNumHeroMessage result = new();
  ...
  public static fclMmtShopNumHeroMessage ReadIn(string[] in_strings, JObject in_metadata) {
    fclMmtShopNumHeroMessage result = new();
