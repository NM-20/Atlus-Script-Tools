...
internal class mypAwardNameTable {
  ...
  */
  ...
  private mypAwardNameTable() {
    Name = "";
  }

  public static mypAwardNameTable ReadIn(BinaryValueReader in_reader) {
    mypAwardNameTable result = new();
  ...
  public static mypAwardNameTable ReadIn(string[] in_strings, JObject in_metadata) {
    mypAwardNameTable result = new();
